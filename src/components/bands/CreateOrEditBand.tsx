...
export default function CreateOrEditBand({ ratings, genres }: Props) {
  const { setShowForm, selectedBand } = useBandStore();
  ...
  return (
    <div className="my-8 flex mb-16">
      ...
      <form
        ...
        ref={formRef}
      >
         {<h2 className="text-xl font-light mb-2 text-center">{selectedBand ? `Update ${selectedBand.name}` : 'Add new band'}</h2>}
